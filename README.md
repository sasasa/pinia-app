<!--
curl -s "https://laravel.build/pinia-app" | bash
sail up -d
...
sail artisan make:model --controller --factory --migration --seed Product
sail artisan make:model --factory --migration --seed Stock
sail artisan make:controller StockController
sail artisan make:request StockRequest

sail artisan make:model --controller --migration  Cart
